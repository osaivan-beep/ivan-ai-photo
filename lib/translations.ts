...
export const translations = {
  en: {
    ...
    instructionalPrompt: "IMPORTANT: The red/colored lines on the input image are a MASK. They indicate the area to edit. 1. You MUST remove these red lines completely from the final output. 2. Inpaint/Edit the area covered by the lines according to the user's prompt. 3. Do not change unaffected areas. The final image should look natural with NO red lines remaining. If there are NO red lines, apply the prompt to the ENTIRE image globally.",
    ...
    magicEraserButton: "Magic Erase (5 Credits)",
    ...
    enhancePromptButton: "Magic Enhance (3 Credits)",
    ...
    panModeButton: "Pan Mode (Hand Tool)",
    // Auth & Credits
    landingTitle: "Welcome to Ivan Ai Photo",
    landingSubtitle: "Professional AI Photo Editing",
    userLoginTab: "User Entrance",
    adminSetupTab: "Admin Initialization",
    loginTitle: "Login",
    ...
    setupTitle: "Admin Initialization",
    ...
    adminEmailPlaceholder: "Admin Email (Required for setup)",
    saveConfigButton: "Initialize & Connect",
    ...
    adminEmailValidation: "Access Denied: Only the specified administrator email (osa.ivan@gmail.com) can initialize the system.",
    systemNotReady: "⚠️ System not initialized. Please ask the administrator for the share link or initialize as Admin.",
    adminPanelTitle: "Admin Panel",
    addCreditsButton: "Add Credits",
    targetEmailLabel: "User Email",
    amountLabel: "Amount",
    creditsAddedSuccess: "Credits updated successfully!",
    creditsAddedError: "Failed to update credits.",
    logoutButton: "Logout",
    shareLinkButton: "Copy Share Link for Users",
    shareLinkCopied: "Share link copied! Send this to your users to grant them access.",
    shareLinkInstructions: "Configure the system below, then copy the Share Link to invite users.",
    cost1K: "3 Credits",
    cost2K: "5 Credits",
    cost4K: "7 Credits",
    ...
    systemConfiguredEmbedded: "System Configured via Code",
    defaultQuickPrompts: {
  ...
  zh: {
    ...
    instructionalPrompt: "重要提示：圖像上的紅色/彩色線條是編輯遮罩。這些線條標示了需要編輯的區域。1. 您必須在最終圖像中【完全移除】這些紅線。2. 根據用戶的提示對線條覆蓋的區域進行修圖/重繪。3. 保持其餘區域不變。最終圖像必須自然且【不包含】任何紅色標記線。如果沒有任何紅線，請對整張圖片進行全局編輯。",
    ...
    enhancePromptButton: "AI 優化題示詞 (3 積分)",
    refiningButton: "優化中...",
    ...
    panModeButton: "平移模式 (手形工具)",
    // Auth & Credits
    landingTitle: "歡迎來到伊凡 Ai Photo",
    landingSubtitle: "專業級 AI 圖像編輯",
    userLoginTab: "使用者登入",
    adminSetupTab: "管理員初始化",
    loginTitle: "登入",
    registerTitle: "註冊帳號",
    emailLabel: "Email",
    passwordLabel: "密碼",
    ...
    resetPasswordSent: "重設信已寄出！請檢查您的信箱。",
    creditsLabel: "剩餘積分",
    ...
    adminEmailPlaceholder: "管理員 Email (僅限指定信箱)",
    saveConfigButton: "初始化並連線",
    ...
    adminEmailValidation: "權限拒絕：只有指定的管理員 Email (osa.ivan@gmail.com) 可以初始化系統。",
    systemNotReady: "⚠️ 系統尚未初始化。請向管理員索取分享連結或以管理員身分初始化。",
    adminPanelTitle: "管理員後台",
    addCreditsButton: "增加積分",
    targetEmailLabel: "用戶 Email",
    amountLabel: "積分數量",
    creditsAddedSuccess: "積分更新成功！",
    creditsAddedError: "增加失敗，請確認 Email 正確。",
    logoutButton: "登出",
    shareLinkButton: "複製使用者分享連結",
    shareLinkCopied: "分享連結已複製！發送此連結給使用者以授權訪問。",
    shareLinkInstructions: "請在下方設定系統，完成後複製分享連結邀請使用者。",
    cost1K: "3 積分",
    cost2K: "5 積分",
    cost4K: "7 積分",
    userListTitle: "使用者管理",
    ...
    refreshList: "重新整理列表",
    noUsersFound: "找不到使用者。",
    systemConfiguredEmbedded: "系統已內建設定",
    defaultQuickPrompts: {
